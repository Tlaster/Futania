...
inline fun <reified T: Activity> Activity.openActivityForResult(requestCode: Int, intent: Intent? = null) {
...
inline fun <reified T: Activity> Fragment.openActivityForResult(requestCode: Int, intent: Intent? = null) {
